...
# MR MVC Framework (Blog System)
> **Note:** This repository contains the core code of a Custom MVC Framework + Advance Blog System by following MVC pattern inspired by CodeIgniter.
...
## About The Project
Model–view–controller is a software design pattern commonly used for developing user interfaces which divides the related program logic into three interconnected elements. This is done to separate internal representations of information from the ways information is presented to and accepted from the user. In this project, I have made my own Custom MVC Framwork along with Blog System by following MVC pattern using PHP, OOP, MySQL inspired by CodeIgniter.
...
* Full featured custom MVC FrameWork
* An advance Blog System
