...
#postinput {border:1px solid #ddd;margin-bottom:5px;padding:5px;width:351px;font-size:16px; cursor: pointer;}
...
<body>
  <header class="headeroption">
    <h2>Advanced BLOG [MVC Framework]</h2>
	
  </header>
<div class="content">

	<p>Admin Panel <span style="float: right;"><a href="<?php echo BASE_URL; ?>" target="_blank">Visit Website. </a></span></p>
	<hr>
